...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function createTicket() and createOrganizedEvent() and  that allows a organizer to create an organized event and a ticket", async () => {
        ...
        await supplyChain.createOrganizedEvent(originOrganizerID, originOrganizerName, originOrganizerInformation, {from: ownerID}).then((result) => {
        ...
        await supplyChain.createTicket(organizedEventID, productNotes, validatorID, {from: originOrganizerID}).then((result) => {
